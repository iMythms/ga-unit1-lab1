...
const generateEmail = (name, domain) => {
	return `Your name is ${name}, and your email address is ${name}@${domain}`
}

console.log('Exercise 4 Result:', generateEmail('mytham', 'imythms.com'))
console.log('Exercise 4 Result:', generateEmail('jasim', 'imythms.com'))
...
console.log('Exercise 5 Result:', greetUser('Mytham', 'morning'))
console.log('Exercise 5 Result:', greetUser('Ali', 'afternoon'))
console.log('Exercise 5 Result:', greetUser('Jasim', 'evening'))
...
console.log('Exercise 9 Result:', basicCalculator(10, 5, 'blah'))
